	...
	public static void doLayout(ServletContext context, PrintWriter writer,String content, String nome_utente, boolean logged, boolean admin){
		...
		if(!logged) {
			String full = HTMLLoader.load(context, "files/fulllayout.part.html")+"\n<div align=\"center\">\r\n"
				...
				+ "<table>\r\n"
				+ "  <tr>\r\n"
				+ "    <th style=\"border: 1px solid yellow; background-color: yellow\"><a href=\"Homepage\" style=\"background-color: yellow; color: red;\">HOME</a></th>\r\n"
				+ "    <th style=\"border: 1px solid yellow; background-color: yellow\"><a href=\"Punteggi\" style=\"background-color: yellow; color: red\">PUNTEGGI</a></th>\r\n"
		...
		writer.write(full.replace("$content$", content));
			...
			String full = HTMLLoader.load(context, "files/fulllayout.part.html")+"\n<div align=\"center\">\r\n"
					...
					+ "    <th style=\"border: 1px solid yellow; background-color: yellow\"><a href=\"Logout\" style=\"background-color: yellow; color: red\">LOGOUT</a></th>\r\n"
					+ "    \r\n"
					+ "  </tr>\r\n"
					+ "\r\n"
					+ "</table>\r\n"
			...
			String full = HTMLLoader.load(context, "files/fulllayout.part.html")+"\n<div align=\"center\">\r\n"
					...
					HTMLLoader.load(context, "files/footer.html");
			writer.write(full.replace("$content$", content));
		} else if(nome_utente.equals(null)) {
			String full = HTMLLoader.load(context, "files/fulllayout.part.html")
					+HTMLLoader.load(context, "files/footer.html");
			writer.write(full.replace("$content$", content));
		}
